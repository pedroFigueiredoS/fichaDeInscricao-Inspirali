...
class InscricaoTransferenciaExterna {
  static completeTheApplicationStarted() {
    ...
    Cypress.env('emailGerado', email); // salva o e-mail
  ...
  static Entrydetails() {
    ...
    cy.get(elementsFichaDeInscricao.TitleCupom)
      .should('be.visible')
      .and('have.text', 'Possui algum Código Promocional?');

    cy.get(elementsFichaDeInscricao.ButtonYes)
      .should('be.visible')
      .click();

    cy.get(elementsFichaDeInscricao.TitlePromotionCode)
      .should('be.visible')
      .and('have.text', 'Código Promocional');
...
export default InscricaoTransferenciaExterna;
